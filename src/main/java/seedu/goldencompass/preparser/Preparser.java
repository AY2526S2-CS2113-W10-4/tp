...
public class Preparser {
     ...
     * @throws GoldenCompassParsingException if {@code text} starts with {@code -} but not found in the Set of all flags.
     */
     ...
     * @throws GoldenCompassParsingException if a non-recognizable flag is detected or a parameter is not identified by any flag.
